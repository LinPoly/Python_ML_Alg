...
def generate_problem(n=200, num_basis_fns=400, num_nonzero=10, noise_scale=.25, tdof=6, test_frac=.2,
...
def main():
    lasso_data_fname = "../data/hw2/lasso_data.pickle"
    LOAD_PROBLEM = True
    ...
    if GENERATE_PROBLEM:
        ...
        (x_train, y_train, x_val, y_val, target_fn, coefs_true,
         featurize) = generate_problem(n=n, num_basis_fns=num_basis_fns, num_nonzero=num_nonzero,
                                       noise_scale=noise_scale, test_frac=test_frac, write_problem=WRITE_PROBLEM,
